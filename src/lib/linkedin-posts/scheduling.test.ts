...
describe('defaultLinkedInSchedule', () => {
  it('schedules Tuesday and Friday at 10:00 Argentina from the linked Sunday', () => {
  ...
  it('keeps the Argentina offset in winter (no daylight saving)', () => {
    expect(defaultLinkedInSchedule('2026-07-05T13:00:00.000Z', 'martes')).toBe('2026-07-07T13:00:00.000Z');
  });
});
