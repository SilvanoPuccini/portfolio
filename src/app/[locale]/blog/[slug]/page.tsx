  ...
  return (
    <div className="site-container py-10 sm:py-12 lg:py-16">
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <header className="mb-12 sm:mb-16">
          <div className="mb-10 flex flex-wrap items-center justify-between gap-3">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="font-mono text-[11px] font-medium uppercase tracking-[0.18em] text-text-secondary">
        ...
        {/* CTA Newsletter */}
        <section className="group relative mt-10 overflow-hidden rounded-sm border border-outline-ghost/10 bg-[rgb(var(--surface-elevated))] px-8 py-10 sm:px-12 sm:py-12">
