...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    let query = getSupabaseAdmin()
      ...
      .select('id, created_at, nombre, email, tipo_proyecto, presupuesto_rango, plazo, estado, monto_presupuestado, proposal_sent_at, ultimo_contacto_at, propuesta_respuesta, contract_sent_at, contrato_vencido_at, contrato_abierto_at, contrato_rechazado_at, fecha_llamada')
