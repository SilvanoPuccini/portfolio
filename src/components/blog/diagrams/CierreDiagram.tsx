...
export function CierreDiagram() {
  return (
    <figure className="not-prose relative left-1/2 my-10 w-[min(96rem,calc(100vw-2rem))] max-w-none -translate-x-1/2 overflow-hidden rounded-2xl border border-[rgb(var(--outline-ghost)/0.18)] bg-[rgb(var(--surface-dim)/0.9)] p-1 shadow-[var(--shadow-ambient)] sm:p-1.5 md:w-[min(70rem,calc(100vw-15rem))]">
      <Image
        src={PIPELINE_IMAGE}
        alt="Pipeline de entrega continua asistido por agentes de IA, desde planificación hasta QA y retroalimentación"
        width={1920}
        height={1180}
        sizes="(min-width: 1360px) 1120px, (min-width: 768px) calc(100vw - 240px), calc(100vw - 32px)"
