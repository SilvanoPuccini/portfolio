...
export const TECH_ICONS: Record<string, TechIcon> = {
  ...
  /*
   * No es una tecnología: es el concepto del post de entrega. Un servidor con
   * la flecha que entra y la que vuelve, porque el post trata tanto de publicar
  ...
  Deploy: {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
        ...
        <rect x="3" y="17.5" width="18" height="4" rx="1.2" stroke="currentColor" strokeWidth="1.3" />
        <circle cx="6" cy="14.5" r=".8" fill="currentColor" />
        <circle cx="6" cy="19.5" r=".8" fill="currentColor" />
        <path d="M9 2.5v7M9 9.5 6.6 7.1M9 9.5l2.4-2.4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M15 9.5V2.5M15 2.5l-2.4 2.4M15 2.5l2.4 2.4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" opacity=".55" />
      </svg>
    ),
  },
  Vite: {
