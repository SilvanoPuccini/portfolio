...
export default function HeroEditorial({
  ...
  const subtitleAccent = "productos digitales";
  const hasSubtitleAccent = content.home.subtitle.includes(subtitleAccent);
  const [subtitlePrefix, subtitleSuffix] = hasSubtitleAccent
    ? content.home.subtitle.split(subtitleAccent)
  ...
  return (
    <section className="relative -mt-28 overflow-hidden bg-[linear-gradient(180deg,rgb(var(--surface-dim)/0.72),rgb(var(--background)/0.92))] pt-28 sm:-mt-[7.5rem] sm:pt-[7.5rem]">
      ...
      <div className="relative mx-auto w-full max-w-[92rem] px-6 py-18 sm:px-8 sm:py-22 lg:px-12 lg:py-28">
