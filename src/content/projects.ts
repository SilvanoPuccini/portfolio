...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2026",
    headline: {
      es: "Plataforma de cursos online multi-plataforma.",
      en: "Multi-platform online course platform.",
    },
    summary: {
      es: "Mi propia versión del proyecto final del curso Claude Code de Platzi, evolucionado a producto completo: desplegado, seguro y rediseñado. Catálogo estilo Netflix con búsqueda inteligente, login server-side, calificaciones seguras, dashboard de aula, sesiones httpOnly, modo oscuro/claro y Open Graph dinámico.",
      en: "My own version of the final Claude Code Platzi course project, evolved into a complete product: deployed, secure and redesigned. Netflix-style catalog with intelligent search, server-side login, secure ratings, classroom dashboard, httpOnly sessions, dark/light mode and dynamic Open Graph.",
    },
    challenge: {
      es: "Transformar el proyecto final del curso Claude Code de Platzi en un producto completo y desplegado, manteniendo la arquitectura base pero evolucionando al gate de contenido, sesiones seguras, rediseño completo y despliegue en producción.",
      en: "Transform the final Claude Code Platzi course project into a complete deployed product, maintaining the base architecture but evolving content gate, secure sessions, full redesign and production deployment.",
    },
    impact: {
      es: [
        "Catálogo estilo Netflix con skeletons, filtros reales y ordenamiento.",
        "Búsqueda inteligente tolerante a tildes y por palabras sueltas con navegación por teclado.",
        "Login gate server-side: temario libre, clase 1 gratuito, resto requiere cuenta.",
        "Calificaciones seguras atadas al JWT con widget interactivo y estadísticas.",
        "Dashboard Mi Aula con 'Continuar viendo', progreso y completados.",
        "Sesiones httpOnly cookie (+ Bearer para apps móviles).",
        "Modo oscuro y light con canvas de marca.",
        "Open Graph dinámico para compartir links bonitos.",
      ],
      en: [
        "Netflix-style catalog with skeletons, real filters and sorting.",
        "Smart search tolerant of tildes and single words with keyboard navigation.",
        "Server-side login gate: free syllabus, first class as preview, rest requires account.",
        "Secure ratings tied to JWT with interactive widget and statistics.",
        "Mi Aula dashboard with 'Continue watching', progress and completed.",
        "httpOnly sessions (+ Bearer available for mobile apps).",
        "Dark and light mode with brand canvas.",
        "Dynamic Open Graph for nice link sharing.",
      ],
    },
    stack: [
      "Next.js 15",
    ...
    links: {
      demo: "https://mindcode-academy.vercel.app",
      repo: "https://github.com/SilvanoPuccini/mindcode-academy",
    },
    media: {
      cover: "/projects/mindcode-academy.png",
      alt: {
        es: "Captura del catálogo de MindCode Academy.",
        en: "MindCode Academy catalog screenshot.",
      },
      assetStatus: "real",
    },
    sourceUrls: [
      "https://raw.githubusercontent.com/SilvanoPuccini/mindcode-academy/main/README.md",
      "https://github.com/SilvanoPuccini/mindcode-academy",
      "https://mindcode-academy.vercel.app",
    ],
  },
  {
