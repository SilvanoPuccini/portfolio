...
<ImageShot src="/blog/cada-herramienta-se-gana-su-lugar/warp-terminal-ia.jpg" alt="Warp · terminal con IA nativa" caption="Warp · terminal con IA nativa" size="full" />
...
<ImageShot src="/blog/cada-herramienta-se-gana-su-lugar/vscode-wsl-ubuntu.jpg" alt="VS Code conectado a WSL: Ubuntu" caption="VS Code conectado a WSL: Ubuntu" size="full" />
...
<ImageShot src="/blog/cada-herramienta-se-gana-su-lugar/claude-code-terminal.jpg" alt="Claude Code · agente principal en la terminal" caption="Claude Code · agente principal en la terminal" size="full" />
